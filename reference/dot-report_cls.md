...
- metric:
  ...
  Not yet implemented. When crossing variables, the cross column
  parameter can contain categorical or metric values. By default, the
  cross column selection is treated as categorical data. Set metric to
  TRUE, to treat it as metric and calculate correlations.
...
- effect:
  ...
  Not yet implemented. Whether to report statistical tests and effect
  sizes.
