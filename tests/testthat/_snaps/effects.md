...
# effect_counts_one_grouped
    ...
    Output
      ...
      |sd_gender | sd_age_group|  n| p_x|  p_y| p_xy| p_x_if_y| p_y_if_x| ratio|   pmi|  npmi| fisher_p| fisher_stars|
      |:---------|------------:|--:|---:|----:|----:|--------:|--------:|-----:|-----:|-----:|--------:|------------:|
      |female    |          40+| 16| 0.4| 0.44| 0.16|     0.36|     0.40|  0.91| -0.14| -0.05|    0.543|             |
      |female    |         < 40| 24| 0.4| 0.56| 0.24|     0.43|     0.60|  1.07|  0.10|  0.05|    0.543|             |
      |male      |          40+| 28| 0.6| 0.44| 0.28|     0.64|     0.47|  1.06|  0.08|  0.05|    0.543|             |
      |male      |         < 40| 32| 0.6| 0.56| 0.32|     0.57|     0.53|  0.95| -0.07| -0.04|    0.543|             |
