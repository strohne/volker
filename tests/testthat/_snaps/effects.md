...
# effect_metrics_items_cor with one variable
    ...
    Output
      ...
      |Expectations: Correlation with Age                          |  n| Pearson's r| ci low| ci high| df|     t|     p| stars| R squared|
      |:-----------------------------------------------------------|--:|-----------:|------:|-------:|--:|-----:|-----:|-----:|---------:|
      |ChatGPT has clear advantages compared to similar offerings. | 97|       -0.12|  -0.32|    0.08| 95| -1.22| 0.227|      |      0.02|
      |Using ChatGPT brings financial benefits.                    | 97|       -0.13|  -0.32|    0.07| 95| -1.29| 0.200|      |      0.02|
      |Using ChatGPT is advantageous in many tasks.                | 97|       -0.09|  -0.28|    0.11| 95| -0.86| 0.393|      |      0.01|
      |Compared to other systems, using ChatGPT is more fun.       | 97|       -0.12|  -0.31|    0.08| 95| -1.15| 0.254|      |      0.01|
      |Much can go wrong when using ChatGPT.                       | 97|        0.18|  -0.02|    0.36| 95|  1.76| 0.082|     .|      0.03|
      |There are legal issues with using ChatGPT.                  | 97|        0.24|   0.05|    0.42| 95|  2.45| 0.016|     *|      0.06|
      |The security of user data is not guaranteed with ChatGPT.   | 97|       -0.10|  -0.29|    0.11| 95| -0.93| 0.354|      |      0.01|
      |Using ChatGPT could bring personal disadvantages.           | 97|        0.02|  -0.18|    0.22| 95|  0.20| 0.846|      |      0.00|
      |In my environment, using ChatGPT is standard.               | 97|       -0.17|  -0.36|    0.03| 95| -1.73| 0.087|     .|      0.03|
      |Almost everyone in my environment uses ChatGPT.             | 97|       -0.06|  -0.26|    0.14| 95| -0.59| 0.557|      |      0.00|
      |Not using ChatGPT is considered being an outsider.          | 97|        0.09|  -0.11|    0.28| 95|  0.87| 0.387|      |      0.01|
      |Using ChatGPT brings me recognition from my environment.    | 97|       -0.02|  -0.22|    0.18| 95| -0.22| 0.823|      |      0.00|
...
# effect_metrics_items_cor with one variable and spearman
    ...
    Output
      ...
      |Expectations: Correlation with Age                          |  n| Spearman's rho|         s|     p| stars|
      |:-----------------------------------------------------------|--:|--------------:|---------:|-----:|-----:|
      |ChatGPT has clear advantages compared to similar offerings. | 97|          -0.14| 172811.45| 0.183|      |
      |Using ChatGPT brings financial benefits.                    | 97|          -0.14| 173694.29| 0.165|      |
      |Using ChatGPT is advantageous in many tasks.                | 97|          -0.13| 171301.35| 0.218|      |
      |Compared to other systems, using ChatGPT is more fun.       | 97|          -0.14| 172970.04| 0.180|      |
      |Much can go wrong when using ChatGPT.                       | 97|           0.17| 126186.26| 0.095|     .|
      |There are legal issues with using ChatGPT.                  | 97|           0.26| 113310.65| 0.012|     *|
      |The security of user data is not guaranteed with ChatGPT.   | 97|          -0.12| 170009.06| 0.251|      |
      |Using ChatGPT could bring personal disadvantages.           | 97|           0.01| 151122.65| 0.950|      |
      |In my environment, using ChatGPT is standard.               | 97|          -0.16| 177123.13| 0.107|      |
      |Almost everyone in my environment uses ChatGPT.             | 97|          -0.07| 162382.67| 0.510|      |
      |Not using ChatGPT is considered being an outsider.          | 97|           0.12| 133571.33| 0.235|      |
      |Using ChatGPT brings me recognition from my environment.    | 97|          -0.01| 153072.54| 0.950|      |
...
# effect_metrics_items_cor with items
    ...
    Output
      ...
      |Using ChatGPT is advantageous in many tasks.                |                Using ChatGPT is advantageous in many tasks.| 97|        1.00|   1.00|    1.00| 95|   Inf| 0.000|   ***|      1.00|
      ...
      |Much can go wrong when using ChatGPT.                       |               In my environment, using ChatGPT is standard.| 97|       -0.19|  -0.37|    0.01| 95| -1.85| 0.068|     .|      0.03|
      ...
      |Using ChatGPT could bring personal disadvantages.           |                Using ChatGPT is advantageous in many tasks.| 97|        0.09|  -0.11|    0.28| 95|  0.87| 0.385|      |      0.01|
      ...
      |Almost everyone in my environment uses ChatGPT.             |               In my environment, using ChatGPT is standard.| 97|        0.73|   0.62|    0.81| 95| 10.47| 0.000|   ***|      0.54|
...
# effect_metrics_items_cor_items with spearman
    ...
    Output
      ...
      |Expectations                                                |                   Usage|  n| Spearman's rho|         s|     p| stars|
      |:-----------------------------------------------------------|-----------------------:|--:|--------------:|---------:|-----:|-----:|
      |ChatGPT has clear advantages compared to similar offerings. |      in private context| 97|           0.47|  80105.62| 0.000|   ***|
      |ChatGPT has clear advantages compared to similar offerings. | in professional context| 97|           0.24| 114894.18| 0.016|     *|
      |Using ChatGPT brings financial benefits.                    |      in private context| 97|           0.18| 125339.91| 0.085|     .|
      |Using ChatGPT brings financial benefits.                    | in professional context| 97|           0.53|  71997.69| 0.000|   ***|
      |Using ChatGPT is advantageous in many tasks.                |      in private context| 97|           0.36|  97859.17| 0.000|   ***|
      |Using ChatGPT is advantageous in many tasks.                | in professional context| 97|           0.33| 101547.31| 0.001|   ***|
      |Compared to other systems, using ChatGPT is more fun.       |      in private context| 97|           0.44|  85529.28| 0.000|   ***|
      |Compared to other systems, using ChatGPT is more fun.       | in professional context| 97|           0.30| 105717.68| 0.002|    **|
      |Much can go wrong when using ChatGPT.                       |      in private context| 97|          -0.24| 188968.80| 0.017|     *|
      |Much can go wrong when using ChatGPT.                       | in professional context| 97|          -0.09| 165913.22| 0.376|      |
      |There are legal issues with using ChatGPT.                  |      in private context| 97|           0.04| 145699.50| 0.683|      |
      |There are legal issues with using ChatGPT.                  | in professional context| 97|           0.30| 106471.16| 0.003|    **|
      |The security of user data is not guaranteed with ChatGPT.   |      in private context| 97|           0.01| 150389.79| 0.913|      |
      |The security of user data is not guaranteed with ChatGPT.   | in professional context| 97|           0.19| 123831.76| 0.068|     .|
      |Using ChatGPT could bring personal disadvantages.           |      in private context| 97|          -0.16| 176795.22| 0.112|      |
      |Using ChatGPT could bring personal disadvantages.           | in professional context| 97|           0.13| 131790.50| 0.192|      |
      |In my environment, using ChatGPT is standard.               |      in private context| 97|           0.34|  99693.66| 0.001|   ***|
      |In my environment, using ChatGPT is standard.               | in professional context| 97|           0.57|  65376.78| 0.000|   ***|
      |Almost everyone in my environment uses ChatGPT.             |      in private context| 97|           0.42|  88556.31| 0.000|   ***|
      |Almost everyone in my environment uses ChatGPT.             | in professional context| 97|           0.52|  72458.11| 0.000|   ***|
      |Not using ChatGPT is considered being an outsider.          |      in private context| 97|           0.26| 112179.86| 0.009|    **|
      |Not using ChatGPT is considered being an outsider.          | in professional context| 97|           0.30| 106146.02| 0.003|    **|
      |Using ChatGPT brings me recognition from my environment.    |      in private context| 97|           0.36|  97537.93| 0.000|   ***|
      |Using ChatGPT brings me recognition from my environment.    | in professional context| 97|           0.40|  90951.57| 0.000|   ***|
