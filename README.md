...
[![Lifecycle: experimental](https://img.shields.io/badge/lifecycle-experimental-orange.svg)](https://lifecycle.r-lib.org/articles/stages.html#experimental) [![R-CMD-check](https://github.com/strohne/volker/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/strohne/volker/actions/workflows/R-CMD-check.yaml)
...
**Hint**: replace `tab_` by `plot_` to reproduce the examples above. You'll find different table, plot and report types in [the introduction vignette](vignettes/introduction.Rmd). For further options to customize the results, see the builtin function help (F1 key).
...
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| \# | function                   | implemented | Effect size                                                                                                          | Estimators                                               | Significance test                             |   |   |   |
+====+============================+=============+======================================================================================================================+==========================================================+===============================================+===+===+===+
| 1  | stat_counts_one            | not yet     | Gini coefficient                                                                                                     | Confidence intervals of the proportion                   | (?) Bootstrap?                                |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 2  | stat_counts_one_grouped    | alpha       | Cramér\'s V                                                                                                          | Confidence intervals of the proportions                  | Chi squared                                   |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 3  | stat_counts_items          | not yet     | Cramér\'s V (?)                                                                                                      | Confidence intervals of the proportions                  | Chi squared (?)                               |   |   |   |
|    |                            |             |                                                                                                                      |                                                          |                                               |   |   |   |
|    |                            |             | Spearman\'s Rho (?)                                                                                                  |                                                          | t-Test (?)                                    |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 4  | stat_counts_items_grouped  | not yet     | Cramér\'s V (?)                                                                                                      | Confidence intervals of the proportion                   | Chi squared (?)                               |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 5  | stat_counts_items_cor      | not yet     | Spearman\'s Rho (?)                                                                                                  |                                                          | t-Test                                        |   |   |   |
|    |                            |             |                                                                                                                      |                                                          |                                               |   |   |   |
|    |                            |             | Cronbach\'s Alpha (?)                                                                                                |                                                          |                                               |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 6  | stat_metrics_one           | not yet     | (?)                                                                                                                  | Confidence intervals of the mean                         | t-Test                                        |   |   |   |
|    |                            |             |                                                                                                                      |                                                          |                                               |   |   |   |
|    |                            |             | Standardized difference to the mean based on reference value (e.g. showing how much sample deviates from population) |                                                          |                                               |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 7  | stat_metrics_one_grouped   | alpha       | Cohen\'s d\                                                                                                          | Confidence intervals of the group means                  | t-Test for independent samples ANOVA (F-Test) |   |   |   |
|    |                            |             | Eta squared                                                                                                          |                                                          |                                               |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 8  | stat_metrics_items         | not yet     | Cohen\'s d                                                                                                           | Confidence intervals of the group means                  | t-Test for paired samples                     |   |   |   |
|    |                            |             |                                                                                                                      |                                                          |                                               |   |   |   |
|    |                            |             | Partial Eta squared / Cohen\'s f                                                                                     |                                                          | Repeated measures ANOVA                       |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 9  | stat_metrics_items_grouped | not yet     | Eta squared                                                                                                          | Confidence intervals of the group means                  | ANOVA (F-Test)                                |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
| 10 | stat_metrics_items_cor     | not yet     | Pearson\'s r                                                                                                         | Pearson\'s r and confidence interval of Pearson\'s r (?) | t-Test                                        |   |   |   |
+----+----------------------------+-------------+----------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------+-----------------------------------------------+---+---+---+
...
The labeling mechanisms follow a technique used, for example, on [SoSci Survey](https://www.soscisurvey.de/). Sidenote for techies: Labels are stored in the column attributes. That's why you can directly throw in labeled data from the SoSci Survey API:
