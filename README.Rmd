...
[![Video tutorial: Introduction to the volkeR package (German)](https://img.youtube.com/vi/9bjF_qxjJgU/0.jpg)](https://www.youtube.com/watch?v=9bjF_qxjJgU)
...
using agree_tab. Hint: You may abbreviate the method name (e.g. "reli" instead of "reliability").
