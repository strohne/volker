...
You'll find an overview about different [tables](vignettes/tables.Rmd), [plots](vignettes/plots.Rmd) and [reports](vignettes/reports.Rmd) in the package vignettes.
