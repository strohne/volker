...
You can conduct some basic statistical tests using the corresponding functions `effects_counts()` and `effects_metrics()`. Those functions are included in the reports if you set the effects-parameter of `report_counts()` or `report_metrics()` to `TRUE`. 
