...
ggsave("plots/examples/plot_counts_one.png", width=300,height=300, units="px", dpi=96)
...
ggsave("plots/examples/plot_metrics_one.png", width=300,height=300, units="px", dpi=96)
...
ggsave("plots/examples/plot_counts_items.png", width=600,height=600, units="px", dpi=96, scale = 0.5)
```
...
ggsave("plots/examples/plot_metrics_items.png", width=300,height=300, units="px", dpi=96, scale = 1.5)
```
...
data %>% 
  ...
  plot_counts(in_adoption, sd_geschlecht, prop="rows", numbers="p") +
  theme(legend.position = "bottom")

ggsave("plots/examples/plot_counts_one_grouped.png", width=300,height=300, units="px", dpi=96, scale = 1)
```
...
ggsave("plots/examples/plot_metrics_one_grouped.png", width=300,height=300, units="px", dpi=96, scale = 1)
```
