...
```{r}
# TODO: Mittelwerte und ci raus, stattdessen in tab_metrics_items_grouped() 
# ci-PArameter ergänzen, der statt sd dann ci (in eckigen Klammern) in den output zipped 
# Done: add eta, remove means from this output, implement in tab_metrics
