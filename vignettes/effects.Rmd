...
| 4  | effect_counts_items                | not yet     | Chi-square goodness-of-fit test for each item                                                    |
| 5  | effect_counts_items_grouped        | not yet     | Cramer's V and Chi-square-test for each item                                                     |
| 6  | effect_counts_items_grouped_items  | not yet     | Correlation of categorical items with categorical items                                          |
...
```{r}
# TODO: error rendering: Can't transform a data frame with duplicate names.
# @JJ
