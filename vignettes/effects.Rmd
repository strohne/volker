...
# 13. Correlation items with items 
```{r}
# equivalent to plot_metrics_items_cor_items?  
effect_metrics(data, starts_with("cg_adoption"), starts_with("use_"), metric = TRUE)

plot_metrics(data, starts_with("cg_adoption"), starts_with("use_"), metric = TRUE)
```
