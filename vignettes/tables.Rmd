...
```{r}
# TODO: redirect to tab_metrics(data, sd_age, adopter) 
...
# tab_counts(data, starts_with("use_"), sd_age)
...
```{r}
tab_metrics(data, starts_with("cg_adoption_adv"), starts_with("cg_adoption_adv"), metric=T, labels=F)
```
