...
### 3. Two variables: One categorical and one metric

```{r}
# Redirected to tab_metrics
tab_counts(data, adopter, sd_age, metric = T, method = "grouped")

# TODO: implement npmi for method cor 
# Implement method param = "cor" vs. "grouped" ? 
tab_counts(data, adopter, use_work, method = "cor")
```
...
tab_counts(data, starts_with("use_"), sd_age, metric = T,  method = "cor")
