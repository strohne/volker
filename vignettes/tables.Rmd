...
# Add a single index
data %>% 
  add_idx("idx_cg_adoption", starts_with("cg_adoption_")) %>% 
  tab_var_metrics(idx_cg_adoption)

# Compare the index values by group
data %>% 
  add_idx("idx_cg_adoption", starts_with("cg_adoption_")) %>% 
  tab_group_metrics(idx_cg_adoption,in_adoption)
...
data %>% 
  ...
  add_idx("idx_cg_adoption_advantage", starts_with("cg_adoption_advantage")) %>%
  add_idx("idx_cg_adoption_fearofuse", starts_with("cg_adoption_fearofuse")) %>% 
  add_idx("idx_cg_adoption_social", starts_with("cg_adoption_social")) %>% 
