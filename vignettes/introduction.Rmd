...
The model functions allow linear modeling by providing a metric outcome as first variable
and a selection of categorical or metric predictor in the respective parameters.

There are two functions: One for getting a regression table and one for plotting the regression coefficients.
