...
# TODO: After adding the model, because the column then exists, following add_model / report calls fail
data <- add_model(
  data, 
  use_work, 
...
# TODO: Handle: vif note
model_tab(data, prd_use_work)
model_plot(data, prd_use_work)

# TODO: Omit adjustment warning (no corresponding output)
