...
# The prop=cells parameter generates a heatmap
plot_counts(data, sd_gender, adopter, prop = "cells", numbers="p")
...
plot_counts(data, starts_with("cg_adoption"), starts_with("cg_adoption"), method="cramer")

data %>% 
  mutate(across(starts_with("cg_act_"), ~ ifelse(is.na(.), FALSE, TRUE))) %>% 
  plot_counts(starts_with("cg_act_"), starts_with("cg_act_"), method="npmi", effect = TRUE)
