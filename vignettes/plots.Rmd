...
### 1. Correlation of multiple items with one metric variable
```{r}
plot_metrics(data, starts_with("use_"), sd_age, metric=T)

```

### 2. Correlation of multiple items by multiple items
```{r}
