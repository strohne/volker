...
| 6  | plot_counts_items_grouped_items  | not yet     | counts    | multiple | counts       | multiple    |
...
data |> 
  select(adopter, cg_adoption_social_04,cg_adoption_social_01,cg_adoption_social_02, cg_adoption_social_03) |> 
  plot_counts(
...
data |> 
  select(cg_adoption_advantage_02, cg_adoption_advantage_01, cg_adoption_advantage_03) |> 
