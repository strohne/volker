...
| 6     | plot_counts_items_cor      |             | plot   | counts   | multiple | correlated |
...
### Correlation of metric items with metric items

```{r, fig.width=6, fig.height=6}

plot_metrics_items_cor_items(
  data, starts_with("cg_adoption"), starts_with("cg_adoption"), metric = TRUE,
  numbers = TRUE
)
