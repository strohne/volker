...
```{r}
plot_counts_one(data, sd_gender, numbers = "n")
```
...
plot_counts(data, sd_gender, adopter, tiles = TRUE, npmi = TRUE, numbers = "n")
...
plot_metrics_items_cor_items(
  data, 
  starts_with("cg_adoption"), starts_with("cg_adoption"), 
  metric = TRUE, 
  labels = FALSE
)
```
