...
## 5. Correlation of multiple items
```{r}
# TODO: Fix heading level ("## 5. Correlation of multiple items" one level down)
# TODO: Es gibt kein plot_metrics_items_cor mehr, Weiche in plot_metrics einbauen und 
#       hier plot_metrics aufrufen
plot_metrics_items_cor(data, starts_with("cg_adoption"), starts_with("cg_adoption"), labels = F, numbers=T)
