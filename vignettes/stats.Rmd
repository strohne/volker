...
# TODO: use confint 
# das heißt vorher confint berechnen und dann reinbringen, 
...
sum <- ds %>%
 ...
 tab_counts_one_grouped(ds, adopter, sd_age)
...
#   }
  ...
  pl <- pl + ggplot2::labs(caption = paste0("n=", base_n, ", ", paste(categorical_n[[1]], "=", categorical_n$n, collapse = ", ")))
